...
app = Flask(__name__)
app.config['SECRET_KEY'] = app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("DATABASE_URL",  "sqlite:///mufiend.db")
Bootstrap(app)
...
# Create DataBase
app.config['SQLALCHEMY_DATABASE_URI'] = "sqlite:///mufiend.db"
